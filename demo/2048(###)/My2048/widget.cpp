...
Widget::Widget(QWidget *parent)
    : QWidget(parent)
{
    this->setMaximumSize(606, 909);
    this->setMinimumSize(404, 606);
    this->resize(404, 606);
    // 初始化最高分为0
    highScore = 0;
    // 读取存储最高分的文件
    ...
    gameWidget->setGeometry(2, 203, 400, 400);
...
void Widget::resizeEvent(QResizeEvent *){
    ...
    // 重置子部件大小和位置
    gameWidget->setGeometry(2 * ratioW, 203 * ratioH, 400 * ratioW, 400 * ratioH);
